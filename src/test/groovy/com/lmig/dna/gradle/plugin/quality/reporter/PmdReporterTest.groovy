...
class PmdReporterTest extends AbstractKitTest {
	...
	def "Check pmd report"() {
		...
		build("""
            ...
            task testReport() << {
                new com.lmig.dna.gradle.plugin.quality.report.PmdReporter().report(project, 'main')
            }
        """)
		file('src/main/java').mkdirs()
		String report = getClass().getResourceAsStream('/com/lmig/dna/gradle/plugin/quality/report/pmd/main.xml').text
